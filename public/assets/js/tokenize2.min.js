...
(function (a) {
    ...
    var a = { BACKSPACE: 8, TAB: 9, ENTER: 13, ESCAPE: 27, ARROW_UP: 38, ARROW_DOWN: 40, CTRL: 17, MAJ: 16, A: 65 };
    c.VERSION = "1.3.6";
    c.DEBOUNCE = null;
    c.DEFAULTS = {
        tokensMaxItems: 0,
    ...
    c.prototype.scaleInput = function () {
        ...
        g =
            ...
            (Math.ceil(parseFloat(this.tokensContainer.css("border-left-width"))) +
                Math.ceil(parseFloat(this.tokensContainer.css("border-right-width")) + Math.ceil(parseFloat(this.tokensContainer.css("padding-left"))) + Math.ceil(parseFloat(this.tokensContainer.css("padding-right")))));
        if (f >= g) {
            f = g;
        }
...
!(function (c, f, a, e) {
    var i = { drag: true, drop: true, exclude: "", nested: true, vertical: true },
        ...
        g = { start: "touchstart.sortable mousedown.sortable", drop: "touchend.sortable touchcancel.sortable mouseup.sortable", drag: "touchmove.sortable mousemove.sortable", scroll: "scroll.sortable" },
        s = "subContainers";
    function r(u, t) {
